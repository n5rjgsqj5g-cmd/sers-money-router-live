...
- **Angebots-Generator:** aus eigenen Fakten sofort eine kopierbare Erstfassung erzeugen und als Textdatei sichern – vollständig lokal im Browser.
...
[Kit als ZIP laden](https://n5rjgsqj5g-cmd.github.io/sers-money-router-live/downloads/ki-angebots-check-v1.0.0.zip) · [Angebots-Generator öffnen](https://n5rjgsqj5g-cmd.github.io/sers-money-router-live/freelancer-angebots-generator.html) · [Angebotsvorlage öffnen](https://n5rjgsqj5g-cmd.github.io/sers-money-router-live/freelancer-angebot-vorlage.html) · [Vorlagen-Release und Prüfsumme](https://github.com/n5rjgsqj5g-cmd/sers-money-router-live/releases/tag/freelancer-angebot-vorlage-v1.0.0)
